...
public class EmployeeServiceTest {
    ...
    public void shouldAddEmployee(){
        ...
        employee.setTanggalLahirEmployee("18-01-2004");
        employee.setTanggalBergabungEmployee("19-19-19");
        employee.setCreateAt("1-8-2025");
        employee.setUpdateAt("1-8-2027");

        EmployeeRequest request = new EmployeeRequest();
        request.setNik(1L);
        request.setNamaLengkapEmployee("Jeremy");
        request.setNomerHpEmployee(012345L);
        request.setTanggalLahirEmployee("18-01-2004");
        request.setTanggalBergabungEmployee("19-19-19");
        request.setCreateAt("1-8-2025");
        request.setUpdateAt("1-8-2027");

        EmployeeResponse response = new EmployeeResponse();
        response.setNik(1L);
        response.setNamaLengkapEmployee("Jeremy");
        response.setNomerHpEmployee(012345L);
        response.setTanggalLahirEmployee("18-01-2004");
        response.setTanggalBergabungEmployee("19-19-19");
        response.setCreateAt("1-8-2025");
        response.setUpdateAt("1-8-2027");
